                    ...
                    {day.messages.map((message: Message, j) => (
                        <div key={j}>
                            {!shouldShowName(day.messages, j) ? (
                                <div className='group relative flex gap-2 px-2 w-full items-center hover:bg-gray-100'>
                                    <div className='w-12 text-white text-center text-xs group-hover:text-dark-3'>
